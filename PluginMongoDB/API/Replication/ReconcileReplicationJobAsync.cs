...
namespace PluginBigQuery.API.Replication
{
    public static partial class Replication
    {
        ...
        public static async Task ReconcileReplicationJobAsync(IClientFactory clientFactory, PrepareWriteRequest request)
        {
            ...
            var safeSchemaName = client.GetDefaultDatabase();
            ...
            if (previousMetaData == null)
            {
                ...
                await EnsureCollectionAsync(clientFactory, goldenTable);
                await EnsureCollectionAsync(clientFactory, versionTable);
            ...
            else
            {
                ...
                if (dropGoldenReason != "")
                {
                    ...
                    await DropCollectionAsync(clientFactory, previousGoldenTable);
                ...
                if (dropVersionReason != "")
                {
                    ...
                    await DropCollectionAsync(clientFactory, previousVersionTable);
